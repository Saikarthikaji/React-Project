                  ...
                  <div className="row justify-content-center">
                    ...
                    <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2 mb-5">
                      <img
                        ...
                        src="https://media.istockphoto.com/id/1299656641/vector/man-putting-esignature-into-legal-document-digital-signature-concept-businessman-signing-an.jpg?s=612x612&w=0&k=20&c=qbLjNgZSutLccD8gTmh3OKstEyVHmcsBrA54f7CRnwk="
                        className="img-fluid"
                        alt="Sample image"
                      />
                    </div>
